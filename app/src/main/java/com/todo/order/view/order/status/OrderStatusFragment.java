...
public class OrderStatusFragment extends Fragment {
    ...
    private TextView tv_order_status_stdt, tv_order_status_eddt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_order_status, container, false);

        ImageButton ib_order_status_stdt = (ImageButton) v.findViewById(R.id.ib_order_status_stdt);
        ImageButton ib_order_status_eddt = (ImageButton) v.findViewById(R.id.ib_order_status_eddt);

        tv_order_status_stdt = (TextView) v.findViewById(R.id.tv_order_status_stdt);
        tv_order_status_eddt = (TextView) v.findViewById(R.id.tv_order_status_eddt);
        ...
        tv_order_status_stdt.setText(strFirstDay);
        tv_order_status_eddt.setText(strLastDay);

        ib_order_status_stdt.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ib_order_status_eddt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
    ...
    private DatePickerDialog.OnDateSetListener dateSetListenerstdt = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int month, int day) {
            month = month + 1;
            tv_order_status_stdt.setText(String.valueOf(year) + "-" + String.format("%02d", month) + "-" + String.format("%02d", day));

            if(mActivity.getClass().equals(OrderStatusActivity.class)) {
                String uid = ((OrderStatusActivity) mActivity).getUid();
                ((OrderStatusActivity) mActivity).getData(API_ACTION, GBN_ORDER_STATUS_LIST, uid, "1", tv_order_status_stdt.getText().toString().replace("-", ""), tv_order_status_eddt.getText().toString().replace("-", ""));
            }
        }
    };
    ...
    private DatePickerDialog.OnDateSetListener dateSetListenereddt = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int month, int day) {
            month = month + 1;
            tv_order_status_eddt.setText(String.valueOf(year) + "-" + String.format("%02d", month) + "-" + String.format("%02d", day));
