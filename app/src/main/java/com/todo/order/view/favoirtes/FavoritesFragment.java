...
public class FavoritesFragment extends Fragment {
    ...
    RecyclerView rvFavoritesFragment;
    ...
    public static FavoritesFragment newInstance(String param1, String param2, String param3) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvFavoritesFragment = v.findViewById(R.id.rvFavoritesFragment);
        ...
        try {
            ...
            for(int i = 0; i < array.length(); i++) {
                ...
                orderItem.setChk(listObj.has("chk") ? listObj.get("chk").toString() : "");
                orderItem.setQty("0");
            ...
            FavoritesAdapter itemAdapter = new FavoritesAdapter(mContext, mOrderItems, activity);
            itemAdapter.notifyDataSetChanged();
            RecyclerView target = v.findViewById(R.id.rvFavoritesFragment);
